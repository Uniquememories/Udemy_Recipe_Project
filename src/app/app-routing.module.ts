...
const appRoutes: Routes = [
  { path: '', redirectTo: '/recipes', pathMatch: 'full' }, //redirect to /recipes //must add the pathMatch and set to full and only redirect if the full path is empty
  {
    ...
    canActivate: [AuthGuard],  //use canActivate key => array of all canActivate guards want to register & register the AuthGuard
    children: [
    ...
    { path: 'auth', component: AuthComponent }//loads the auth page
]
